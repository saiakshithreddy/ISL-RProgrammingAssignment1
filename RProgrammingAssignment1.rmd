...
P.Undergrad: Number of Section-time undergraduates
...
```{r}
college = read.csv('/Users/Akshith/Downloads/RProgrammingLab1/College.csv', header = TRUE)
```
...
```{r}
Auto = read.csv("/Users/Akshith/Downloads/RProgrammingLab1/Auto.csv", header = TRUE, na.strings = "?")
Auto = na.omit(Auto)
dim(Auto)
```
